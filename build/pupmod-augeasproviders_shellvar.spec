%define mod_name augeasproviders_shellvar

Summary: Shellvar Augeas-based providers for Puppet
Name: pupmod-augeasproviders_shellvar
Version: 2.0.1
Release: 0
...
%description
This module provides a type/provider for shell files using the Augeas configuration API library.
